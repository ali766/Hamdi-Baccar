// حط هنا بيانات مشروع Firebase بتاعك (هتلاقيها في: Project settings -> عام -> "Your apps" -> SDK setup and configuration)
// البيانات دي مش سرّية، عادي تكون موجودة في الكود اللي بيتشغل على المتصفح.
